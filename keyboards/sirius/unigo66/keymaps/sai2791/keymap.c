 ...
 *                                        ,-------------.       ,---------------.
 *                                        |      |      |       |      |        |  
 *                                        | Space| Bsp  |       | Tab  |M1/Enter| 
 *                                        |      |      |       |      |        | 
 *                                        `-------------'       `---------------'
 */
    [0] = LAYOUT(
  KC_ESC,  KC_1,   KC_2,   KC_3,   KC_4,   KC_5,   KC_MINS,      KC_EQL,  KC_6,   KC_7,   KC_8,   KC_9,   KC_0,    KC_NO,
  KC_NO,   KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,   KC_PGUP,      KC_LBRC, KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,    KC_BSLS,
  ...
  KC_LCTL, KC_LGUI,KC_LALT,                                                                       KC_LEFT,KC_DOWN, KC_RGHT,
                                           KC_SPC, KC_BSPC,      KC_TAB, LT(1,KC_ENT),
